        ...
        <Row>
          <Col sm={12} className="my-4">
            <div className={styles.privacyPolicyContainer}>
              ...
              <div><strong>Last updated February 25, 2021</strong></div>
              <div>
                Thank you for choosing to be part of our community at Barnwell 6 LLC, doing business as Wave Landscaping &amp; Design ("
                ...
                ", "
                <strong>our</strong>
                "). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice, or our practices with regards to your personal information, please contact us at wavelandscapingdesign@gmail.com.
              </div>
              <div>
                When you visit our website
                {' '}
                <a href="http://www.wavelandscapingandesign.com" target="_blank" rel="noreferrer">http://www.wavelandscapingandesign.com</a>
                {' '}
                (the "
              ...
              <div>This privacy notice applies to all information collected through our Services (which, as described above, includes our Website), as well as, any related services, sales, marketing or events.</div>
              <div><strong>Please read this privacy notice carefully as it will help you understand what we do with the information that we collect.</strong></div>
              ...
              <div><a href="#infoshare" data-custom-class="link">2. WILL YOUR INFORMATION BE SHARED WITH ANYONE?</a></div>
              <div><a href="#intltransfers" data-custom-class="link">3. IS YOUR INFORMATION TRANSFERRED INTERNATIONALLY?</a></div>
              <div><a href="#inforetain" data-custom-class="link">4. HOW LONG DO WE KEEP YOUR INFORMATION?</a></div>
              <div><a href="#infosafe" data-custom-class="link">5. HOW DO WE KEEP YOUR INFORMATION SAFE?</a></div>
              <div><a href="#privacyrights" data-custom-class="link">6. WHAT ARE YOUR PRIVACY RIGHTS?</a></div>
              <div><a href="#DNT" data-custom-class="link">7. CONTROLS FOR DO-NOT-TRACK FEATURES</a></div>
              <div><a href="#caresidents" data-custom-class="link">8. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</a></div>
              <div><a href="#policyupdates" data-custom-class="link">9. DO WE MAKE UPDATES TO THIS NOTICE?</a></div>
              <div><a href="#contact" data-custom-class="link">10. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</a></div>
              <div><a href="#request" data-custom-class="link">11. HOW CAN YOU REVIEW, UPDATE OR DELETE THE DATA WE COLLECT FROM YOU?</a></div>
              <div><strong>1. WHAT INFORMATION DO WE COLLECT?</strong></div>
              <div><strong>2. WILL YOUR INFORMATION BE SHARED WITH ANYONE?</strong></div>
              <div>
              ...
              <div>More specifically, we may need to process your data or share your personal information in the following situations:</div>
              <ul>
                <li>
                  ...
                  <div>
                    <div>
                      <div>
                        <div>
                          <div>
                            <strong>3. IS YOUR INFORMATION TRANSFERRED INTERNATIONALLY?</strong>
                            {' '}
                          </div>
                          <div>
                            <strong><em>In Short: </em></strong>
                          ...
                          <div>
                            Our servers are located in. If you are accessing our Website from outside, please be aware that your information may be transferred to, stored, and processed by us in our facilities and by those third parties with whom we may share your personal information (see "
                            <a href="#infoshare" data-custom-class="link">WILL YOUR INFORMATION BE SHARED WITH ANYONE?</a>
                          ...
                          <div><strong>4. HOW LONG DO WE KEEP YOUR INFORMATION?</strong></div>
                          <div>
                            <strong><em>In Short: </em></strong>
                          ...
                          <div><strong>6. WHAT ARE YOUR PRIVACY RIGHTS?</strong></div>
                          <div>
                            <strong><em>In Short:</em></strong>
                          ...
                          <div>
                            ...
                            <a href="http://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.htm" target="_blank" rel="noopener noreferrer" data-custom-class="link">http://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.htm</a>
                            .
                          </div>
                          <div>
                            If you are a resident in Switzerland, the contact details for the data protection authorities are available here:
                            <a href="https://www.edoeb.admin.ch/edoeb/en/home.html" target="_blank" rel="noopener noreferrer" data-custom-class="link">https://www.edoeb.admin.ch/edoeb/en/home.html</a>
                            .
                          </div>
                          <div><strong>7. CONTROLS FOR DO-NOT-TRACK FEATURES</strong></div>
                          ...
                          <div><strong>8. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</strong></div>
                          <div>
                            <strong><em>In Short: </em></strong>
                          ...
                          <div>If you have questions or comments about this notice, you may email us at wavelandscapingdesign@gmail.com or by post to:</div>
                          <div>Barnwell 6 LLC</div>
                          <div>PO Box 6517</div>
                          <div>Lake Worth, FL 33436-6643</div>
                          ...
                          <div>
                            ...
                            <a href="https://app.termly.io/notify/62355034-235f-49d8-8600-9df59c4d39fb" target="_blank" rel="noopener noreferrer" data-custom-class="link">here</a>
                            . We will respond to your request within 30 days.
                          </div>
                          <p>
                            Use the free
                            <a href="https://html-cleaner.com/js/" rel="nofollow noopener">JavaScript formatter</a>
                            {' '}
                            browser program to manage and tidy your scripts.
                          </p>
                        </div>
                      </div>
                    </div>
